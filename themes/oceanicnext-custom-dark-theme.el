...
(deftheme oceanicnext-custom-dark)
...
(let ((base00 "#1B2B34")
  ...
  (custom-theme-set-faces 
   ...
   `(web-mode-comment-face ((t (:foreground ,base03 :slant italic))))
   `(web-mode-constant-face ((t (:foreground ,base09))))
   `(web-mode-function-name-face ((t (:foreground ,base07))))
   `(web-mode-html-attr-name-face ((t (:foreground ,base0E :slant italic))))
   ...
   `(neo-file-link-face ((t (:foreground ,base0A :weight light))))
...
(provide-theme 'oceanicnext-custom-dark)
